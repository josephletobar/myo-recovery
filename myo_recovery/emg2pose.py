...
def map_hand_pose_to_emg2pose(
    ...
    *,
    ...
    The representation conversion and degrees-to-radians conversion are
    performed without applying a guessed anatomical offset or sign convention.
    The result preserves the source Xsens angles in Meta's 20-column ordering.
    """
